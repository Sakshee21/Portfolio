    ...
    <section id="about" className="relative z-10 py-24 px-6">
      <div className="max-w-6xl mx-auto rounded-[2rem] border border-dark-border bg-dark-card/55 backdrop-blur-md shadow-2xl overflow-hidden">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6">About the Operator</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-10">
            {[
              ...
              <div key={item.label} className="border border-dark-border rounded-2xl p-4 bg-dark-bg/50">
